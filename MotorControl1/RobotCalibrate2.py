...
class RobotCalibrate():
	...
	def __init__(self):
		...
		self.servo1_start_pos = 74.16 #right thigh
		self.servo2_start_pos = 96.96 #right shin
		self.servo3_start_pos = 39.36 #right ankle

		#LEFT LEG STARTING POSITIONS
		self.servo4_start_pos = 49.68 #left thigh
		self.servo5_start_pos = 148.8 #left shin
		self.servo6_start_pos = 41.76 #left ankle
